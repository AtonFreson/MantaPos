...
def main():
    # Configuration
    DATA_FILE = 'test recording - 12-13@19-16.json'
    DATA_FILE = os.path.join(os.path.dirname(__file__), DATA_FILE)
    SENSOR1_CALIBRATION_OUTPUT = 'sensor1_calibration.json'
    SENSOR2_CALIBRATION_OUTPUT = 'sensor2_calibration.json'
    TEST_SIZE = 0.2
    RANDOM_STATE = 42
    ...
    try:
        ...
        print("Evaluating models for Sensor 1 (adc_value0)...")
